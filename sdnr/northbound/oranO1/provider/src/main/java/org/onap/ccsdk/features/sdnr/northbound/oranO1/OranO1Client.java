...
public class OranO1Client {

	private static final Logger LOG = LoggerFactory.getLogger(OranO1Client.class);

	private final SvcLogicService svcLogicService;

	private String ErrorCode = "error-code";

	public OranO1Client(final SvcLogicService svcLogicService) {
