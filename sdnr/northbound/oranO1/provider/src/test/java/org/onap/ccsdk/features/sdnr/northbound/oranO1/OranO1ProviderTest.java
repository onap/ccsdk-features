...
public class OranO1ProviderTest {

  	Logger LOG = LoggerFactory.getLogger(OranO1Provider.class);
  	private OranO1Provider provider;
      ...
      public void setUp() throws Exception {
          ...
          BindingAwareBroker.RpcRegistration<OranO1ApiService> rpcRegistration = (BindingAwareBroker.RpcRegistration<OranO1ApiService>) mock(BindingAwareBroker.RpcRegistration.class);
          when(rpcRegistry.addRpcImplementation(any(Class.class), any(OranO1ApiService.class))).thenReturn(rpcRegistration);


          // Load svclogic.properties and get a SvcLogicStore
          InputStream propStr = OranO1ProviderTest.class.getResourceAsStream("/svclogic.properties");
          ...
          URL graphUrl = OranO1ProviderTest.class.getClassLoader().getResource("graphs");
          ...
          OranO1Client client = new OranO1Client(svc);
          provider = new OranO1Provider(dataBroker, notifyService, rpcRegistry, client);
      }
