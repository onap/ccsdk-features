...
public class A1AdapterProvider implements AutoCloseable, A1ADAPTERAPIService {
    ...
    private Map<String, Builder<?>> serviceData =
            ImmutableMap.<String, Builder<?>>builder().put(GET_NEARRT_RICS, new GetNearRTRICsOutputBuilder())
                    .put(GET_HEALTH_CHECK, new GetHealthCheckInputBuilder())
                    .put(GET_POLICY_TYPES, new GetPolicyTypesOutputBuilder())
                    .put(CREATE_POLICY_TYPE, new CreatePolicyTypeOutputBuilder()).build();
    ...
    private Builder<?> getServiceData(String svcOperation) {
        return serviceData.get(svcOperation);
    }
