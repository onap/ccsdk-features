...
public class TestOnf14DomWireInterfaceNotificationListener extends Mockito {
    ...
    public void testOtherNotif() {
        Onf14DomWireInterfaceNotificationListener notifListener =
                new Onf14DomWireInterfaceNotificationListener(accessor, serviceProvider);

        NetconfDeviceNotification ndn =
                new NetconfDeviceNotification(createWireInterfaceCreationNotification(), Instant.now());
        notifListener.onNotification(ndn);
        ndn = new NetconfDeviceNotification(createWireInterfaceAVCNotification(), Instant.now());
        notifListener.onNotification(ndn);
        ndn = new NetconfDeviceNotification(createWireInterfaceDeletionNotification(), Instant.now());
        notifListener.onNotification(ndn);
        ndn = new NetconfDeviceNotification(createWireInterfaceProblemNotification(), Instant.now());
        notifListener.onNotification(ndn);
    }

    private ContainerNode createWireInterfaceProblemNotification() {
        return Builders.containerBuilder()
                .withNodeIdentifier(
                        NodeIdentifier.create(Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_PROBLEM_NOTIFICATION))
                .withChild(ImmutableNodes
                        .leafNode(Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_PROBLEM_NOTIFICATION_COUNTER, "47"))
    ...
    private ContainerNode createWireInterfaceAVCNotification() {
        return Builders.containerBuilder()
                .withNodeIdentifier(
                        NodeIdentifier.create(Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_AVC_NOTIFICATION))
                .withChild(ImmutableNodes
                        .leafNode(Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_AVC_NOTIFICATION_COUNTER, "47"))
                .withChild(ImmutableNodes.leafNode(
                        Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_AVC_NOTIFICATION_ATTRIBUTE_NAME,
                        "12345678-0123-2345-abcd-0123456789AB"))
                .withChild(ImmutableNodes.leafNode(
                        Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_AVC_NOTIFICATION_NEW_VALUE, "new-value"))
                .withChild(ImmutableNodes.leafNode(
                        Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_AVC_NOTIFICATION_OBJECT_ID_REF,
                        "12345678-0123-1234-abcd-0123456789AB"))
                .withChild(ImmutableNodes.leafNode(
                        Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_AVC_NOTIFICATION_TIMESTAMP,
                        "2022-02-05T12:30:45.283Z"))
                .build();
    }

    private ContainerNode createWireInterfaceDeletionNotification() {
        return Builders.containerBuilder()
                .withNodeIdentifier(
                        NodeIdentifier.create(Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_DELETE_NOTIFICATION))
                .withChild(ImmutableNodes
                        .leafNode(Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_DELETE_NOTIFICATION_COUNTER, "47"))
                .withChild(ImmutableNodes.leafNode(
    ...
    private ContainerNode createWireInterfaceCreationNotification() {
        return Builders.containerBuilder()
                .withNodeIdentifier(
                        NodeIdentifier.create(Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_CREATE_NOTIFICATION))
                .withChild(ImmutableNodes
                        .leafNode(Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_CREATE_NOTIFICATION_COUNTER, "47"))
                .withChild(ImmutableNodes.leafNode(
                        Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_CREATE_NOTIFICATION_OBJECT_TYPE,
                        "Wire-interface-name"))
                .withChild(ImmutableNodes.leafNode(
                        Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_CREATE_NOTIFICATION_TIMESTAMP,
                        "2022-02-05T12:30:45.283Z"))
                .withChild(ImmutableNodes.leafNode(
                        Onf14DevicemanagerQNames.WIRE_INTERFACE_OBJECT_CREATE_NOTIFICATION_OBJECT_ID_REF,
                        "12345678-0123-1234-abcd-0123456789AB"))
                .build();
    }
