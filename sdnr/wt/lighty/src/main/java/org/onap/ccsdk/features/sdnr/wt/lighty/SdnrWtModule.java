...
public class SdnrWtModule extends AbstractLightyModule {
    ...
    public SdnrWtModule(DataBroker dataBroker, RpcProviderRegistry rpcProviderRegistry,
            ...
            ClusterSingletonServiceProvider clusteringSingletonService, RpcProviderService rpcProviderService) {
    ...
    protected boolean initProcedure() {
        ...
        this.sdnrWtWebsocketManager2Module = new SdnrWtWebsocketManager2Module(rpcProviderService);
