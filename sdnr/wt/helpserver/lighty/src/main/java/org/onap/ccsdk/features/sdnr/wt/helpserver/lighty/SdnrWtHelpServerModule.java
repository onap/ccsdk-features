...
import org.onap.ccsdk.features.sdnr.wt.helpserver.HelpServletLighty;
...
public class SdnrWtHelpServerModule extends AbstractLightyModule {
    ...
    private HelpServletLighty helpServlet;

    @Override
    protected boolean initProcedure() {
        helpServlet = new HelpServletLighty();
        return true;
    }
    ...
    public HttpServlet getHelpServlet() {
        return helpServlet;
    }
}
