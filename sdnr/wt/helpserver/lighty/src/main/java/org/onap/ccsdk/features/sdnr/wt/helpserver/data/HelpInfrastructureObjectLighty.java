...
/**
 * THIS CLASS IS A COPY OF {@link HelpInfrastructureObject} WITH REMOVED OSGi DEPENDENCIES
 */
public class HelpInfrastructureObjectLighty extends JSONObject {

    private static final Logger LOG = LoggerFactory.getLogger(HelpInfrastructureObjectLighty.class);
    ...
    public HelpInfrastructureObjectLighty(Path pRoot) throws URISyntaxException {
    ...
    public static void createFilesFromResources() {
        ...
        LOG.info("Extract");
        LOG.info("Use target in filesystem.");
        // URL helpRessource =
