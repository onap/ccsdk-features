...
import org.onap.ccsdk.features.sdnr.wt.helpserver.data.HelpInfrastructureObjectLighty;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * THIS CLASS IS A COPY OF {@link HelpServlet} WITH REMOVED OSGi DEPENDENCIES
 */
public class HelpServletLighty extends HttpServlet implements AutoCloseable {

    private static Logger LOG = LoggerFactory.getLogger(HelpServletLighty.class);
    ...
    public HelpServletLighty() {
        LOG.info("Starting HelpServlet instance {}", this.hashCode());
        HelpInfrastructureObjectLighty.createFilesFromResources();
        this.basePath = HelpInfrastructureObjectLighty.getHelpDirectoryBase();
    }
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (query != null && query.contains("meta")) {
            ...
            File f = new File(HelpInfrastructureObjectLighty.KARAFHELPDIRECTORY, "meta.json");
            if (f.exists()) {
                ...
                HelpInfrastructureObjectLighty o = null;
                try {
                    o = new HelpInfrastructureObjectLighty(this.basePath);
