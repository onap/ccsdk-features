...
public class TestYangGenSalMapping {
    ...
    public void test2() throws Exception {
        ...
        HtDatabaseClient db = HtDatabaseClient.getClient(HOSTINFOS);
    ...
    public void test6() throws Exception {
        out(method());
        HtDatabaseClient dbClient = HtDatabaseClient.getClient(new HostInfo[] {new HostInfo("sdnrdb", 9200, Protocol.HTTP)});
