...
public class MariaDBTestBase {
    ...
    public MariaDBTestBase(String host, int port, String dbName) {
        ...
        this.config = new MariaDBConfig(new ConfigurationFileRepresentation("test.properties"));
    ...
    public MariaDBClient createRawClient() {
        return new MariaDBClient(this.config.getUrl(), this.config.getUsername(), this.config.getPassword());
    }
    ...
    public static void testCreateTableStructure(MariaDBClient dbService) {
    ...
    public static boolean createTableOdl(MariaDBClient dbService) {
    ...
    public static boolean createTable(MariaDBClient dbService, Class<?> cls, Entity entity, boolean autoIndex) {
        String createStatement = null;
        try {
