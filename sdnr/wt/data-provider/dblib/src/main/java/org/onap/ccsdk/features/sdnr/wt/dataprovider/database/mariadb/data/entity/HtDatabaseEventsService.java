...
import org.onap.ccsdk.features.sdnr.wt.dataprovider.database.mariadb.database.MariaDBReaderWriterFault;
import org.onap.ccsdk.features.sdnr.wt.dataprovider.database.mariadb.database.MariaDBReaderWriterPm;
...
public class HtDatabaseEventsService implements DataProvider {
    ...
    protected final MariaDBClient dbClient;
    protected final String controllerId;
    protected final MariaDBReaderWriter<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.data.provider.rev201110.read.connectionlog.list.output.Data> connectionlogRW;
    protected final MariaDBReaderWriter<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.data.provider.rev201110.read.eventlog.list.output.Data> eventlogRW;
    protected final MariaDBReaderWriter<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.data.provider.rev201110.read.faultlog.list.output.Data> eventRWFaultLog;
    protected final MariaDBReaderWriterFault<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.data.provider.rev201110.read.faultcurrent.list.output.Data> eventRWFaultCurrent;
    protected final MariaDBReaderWriter<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.data.provider.rev201110.read.inventory.list.output.Data> equipmentRW;
    protected final MariaDBReaderWriter<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.data.provider.rev201110.read.gui.cut.through.entry.output.Data> guicutthroughRW;
    protected final MariaDBReaderWriter<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.data.provider.rev201110.read.network.element.connection.list.output.Data> networkelementConnectionRW;
    protected final MariaDBReaderWriterPm<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.data.provider.rev201110.read.pmdata._15m.list.output.Data> pm15mRW;
    protected final MariaDBReaderWriterPm<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.data.provider.rev201110.read.pmdata._24h.list.output.Data> pm24hRW;
    protected final String controllerTableName;

    public HtDatabaseEventsService(MariaDBConfig config) {
        ...
        this.controllerTableName = MariaDBMapper.TABLENAME_CONTROLLER + config.getDbSuffix();
        this.dbClient = new MariaDBClient(config.getUrl(), config.getUsername(), config.getPassword());
        this.connectionlogRW = new MariaDBReaderWriter<>(dbClient, Entity.Connectionlog, config.getDbSuffix(),
        ...
        this.eventlogRW = new MariaDBReaderWriter<>(dbClient, Entity.Eventlog, config.getDbSuffix(),
                ...
                this.dbClient.getDatabaseName(), this.controllerId);
        this.eventRWFaultLog = new MariaDBReaderWriter<>(dbClient, Entity.Faultlog, config.getDbSuffix(),
                ...
                this.dbClient.getDatabaseName(), this.controllerId);
        this.eventRWFaultCurrent = new MariaDBReaderWriterFault<>(dbClient, Entity.Faultcurrent, config.getDbSuffix(),
                ...
                this.dbClient.getDatabaseName(), this.controllerId);
        this.equipmentRW = new MariaDBReaderWriter<>(dbClient, Entity.Inventoryequipment, config.getDbSuffix(),
                ...
                this.dbClient.getDatabaseName(), this.controllerId);
        this.guicutthroughRW = new MariaDBReaderWriter<>(dbClient,
        ...
        this.networkelementConnectionRW = new MariaDBReaderWriter<>(dbClient, Entity.NetworkelementConnection,
                config.getDbSuffix(),
        ...
        this.pm15mRW = new MariaDBReaderWriterPm<>(dbClient, Entity.Historicalperformance15min, config.getDbSuffix(),
        ...
        this.pm24hRW = new MariaDBReaderWriterPm<>(dbClient, Entity.Historicalperformance24h, config.getDbSuffix(),
