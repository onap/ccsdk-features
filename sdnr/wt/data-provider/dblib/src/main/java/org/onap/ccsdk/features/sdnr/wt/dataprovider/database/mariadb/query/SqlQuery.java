...
import org.onap.ccsdk.features.sdnr.wt.dataprovider.database.mariadb.query.filters.DBFilterKeyValuePair;
import org.onap.ccsdk.features.sdnr.wt.dataprovider.database.mariadb.query.filters.RangeMariaDBFilter;
import org.onap.ccsdk.features.sdnr.wt.dataprovider.database.mariadb.query.filters.RegexMariaDBFilter;
...
public interface SqlQuery {
    ...
    public static String getFilterExpression(String property, String value) {
        ...
        if (DbFilter.hasSearchParams(value)) {
            ...
            return new RegexMariaDBFilter(property, value).getFilterExpression();
    ...
    private static String getComparisonFilter(String property, String filtervalue, boolean asTimeStamp) {
        ...
        value = filtervalue;
        return new RangeMariaDBFilter(property, value, comparator).getFilterExpression();
    }
    ...
    private static @Nullable String fromTimestampSearchFilter(String property, String value) {
        ...
        return RangeMariaDBFilter.between(property, netconfToMariaDBTimestamp(lowerEnd), true,
