      ...
      <AppBar position="absolute" className={classes.appBar}>
        <Toolbar>
          ...
          <div className={classes.notifications}>
            {
              state.framework.applicationState.isWebsocketAvailable != undefined ?
                (state.framework.applicationState.isWebsocketAvailable ?
                  <Typography variant="body1">Notifications <Adjust className={classes.connected} /></Typography> : <Typography variant="body1">Notifications <Block className={classes.notConnected} /></Typography>)
                : <Typography variant="body1">Notifications N/A</Typography>
            }
          </div>
