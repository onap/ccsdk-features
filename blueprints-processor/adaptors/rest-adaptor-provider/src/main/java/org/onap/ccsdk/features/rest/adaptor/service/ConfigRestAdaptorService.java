...
public interface ConfigRestAdaptorService {
   ...
   */
  public <T> T exchangeResource(String selectorName, String path, Object request, Class<T> responseType, String method)
      throws ConfigRestAdaptorException;
   ...
   * @param request the Object to be POSTed, may be {@code null}
   */
  public RestResponse postResource(String selectorName, String path, Object request) throws ConfigRestAdaptorException;
