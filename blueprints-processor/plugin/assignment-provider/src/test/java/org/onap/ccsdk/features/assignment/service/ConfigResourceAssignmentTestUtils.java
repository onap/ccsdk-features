    ...
    Mockito.doAnswer(new Answer<ConfigModel>() {
      ...
      public org.onap.ccsdk.features.model.domain.ConfigModel answer(InvocationOnMock invocationOnMock)
        ...
        if (args != null && args.length == 3) {
          ...
          Collection<File> templateFiles = FileUtils.listFiles(new File(velocityDir), new String[] {"vtl"}, true);
    ...
    Mockito.doAnswer(new Answer<String>() {
      ...
      public String answer(InvocationOnMock invocationOnMock) throws Throwable {
        ...
        if (args != null) {
          ...
          dictionaties =
              IOUtils.toString(ConfigAssignmentNodeTest.class.getClassLoader().getResourceAsStream(dictionaryFileName),
                  Charset.defaultCharset());
        }
        return dictionaties;
      }
