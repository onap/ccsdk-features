...
public class InputResourceProcessorTest {
  ...
  public void testInputSimpleProcess() throws Exception {
    ...
    String resourceassignmentContent = FileUtils.readFileToString(
        new File("src/test/resources/mapping/input/resource-assignments-simple.json"), Charset.defaultCharset());
  ...
  public void testInputComplexProcess() throws Exception {
    ...
    String resourceassignmentContent = FileUtils.readFileToString(
        new File("src/test/resources/mapping/input/resource-assignments-complex.json"), Charset.defaultCharset());
    List<ResourceAssignment> batchResourceAssignment =
        TransformationUtils.getListfromJson(resourceassignmentContent, ResourceAssignment.class);

    String dictionaryContent = FileUtils
        .readFileToString(new File("src/test/resources/mapping/input/input-complex.json"), Charset.defaultCharset());
    Map<String, ResourceDefinition> dictionaries = ConfigResourceAssignmentTestUtils.getMapfromJson(dictionaryContent);
    ...
    Map<String, String> inParams = new HashMap<>();
    SvcLogicContext ctx = new SvcLogicContext();
    String datatypeContent = FileUtils.readFileToString(new File("src/test/resources/mapping/input/dt-location.json"),
        Charset.defaultCharset());
    ctx.setAttribute("data_types.dt-location", datatypeContent);

    String samplelocation = FileUtils
        .readFileToString(new File("src/test/resources/mapping/input/sample-location.json"), Charset.defaultCharset());
