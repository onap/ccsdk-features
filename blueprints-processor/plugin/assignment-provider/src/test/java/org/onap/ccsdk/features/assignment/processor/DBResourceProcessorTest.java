...
public class DBResourceProcessorTest {
  ...
  public void testDbSimpleProcess() throws Exception {
    ...
    String dictionaryContent =
        FileUtils.readFileToString(new File("src/test/resources/mapping/db/db-simple.json"), Charset.defaultCharset());
  ...
  public void testDbComplexProcess() throws Exception {
    ...
    String dictionaryContent =
        FileUtils.readFileToString(new File("src/test/resources/mapping/db/db-complex.json"), Charset.defaultCharset());
    Map<String, ResourceDefinition> dictionaries = ConfigResourceAssignmentTestUtils.getMapfromJson(dictionaryContent);
    DBResourceProcessor dbResourceProcessor = new DBResourceProcessor(configResourceService);
    Map<String, Object> componentContext = new HashMap<>();
    componentContext.put(ConfigModelConstant.PROPERTY_RESOURCE_ASSIGNMENTS, batchResourceAssignment);
  ...
  public void testDbArrayComplexProcess() throws Exception {
    ...
    String dictionaryContent =
        FileUtils.readFileToString(new File("src/test/resources/mapping/db/db-array.json"), Charset.defaultCharset());
    Map<String, ResourceDefinition> dictionaries = ConfigResourceAssignmentTestUtils.getMapfromJson(dictionaryContent);
    DBResourceProcessor dbResourceProcessor = new DBResourceProcessor(configResourceService);
    Map<String, Object> componentContext = new HashMap<>();
    componentContext.put(ConfigModelConstant.PROPERTY_RESOURCE_ASSIGNMENTS, batchResourceAssignment);
