...
public class JsonUtilsTest {
  ...
  public void testPopulateJsonNodeValues() {
    ObjectNode objectNode = JsonNodeFactory.instance.objectNode();
    JsonUtils.populateJsonNodeValues("key1", JsonNodeFactory.instance.textNode("value"), ValidTypes.DATA_TYPE_STRING,
        objectNode);
    JsonUtils.populateJsonNodeValues("key2", JsonNodeFactory.instance.booleanNode(true), ValidTypes.DATA_TYPE_BOOLEAN,
        objectNode);
