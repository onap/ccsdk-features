...
public class ResourceDictionaryUtilsTest {
  ...
  public void testSourceMdsal() {
    ...
    Assert.assertNotNull("Resource assignment mdsal sourceName is missing ", resourceAssignment.getDictionarySource());
    Assert.assertNotNull("Resource assignment mdsal sourceName property is missing ", resourceAssignment.getProperty());
