...
public class ServiceTemplateCreateUtils {
  ...
  public void createNodeTypes(String serviceTemplateFileName) throws IOException {
    if (StringUtils.isNotBlank(serviceTemplateFileName)) {
      String fileContent = FileUtils.readFileToString(new File(serviceTemplateFileName), Charset.defaultCharset());
      ...
      serviceTemplate.getNodeTypes().forEach((nodeTypeKey, node_types) -> {
        ...
        if (node_types != null && StringUtils.isNotBlank(node_types.getDerivedFrom())) {
          ...
          try {
            ...
            if (ConfigModelConstant.MODEL_TYPE_NODE_COMPONENT.equalsIgnoreCase(node_types.getDerivedFrom())) {
  ...
  public void createResourceAssignmentNodeTemplate(ServiceTemplate serviceTemplate) throws IOException {
    if (serviceTemplate != null) {
      ...
      File resourceAssignmetFile =
          new File("../../../plugin/assignment/provider/src/test/resources/service_templates/resource_assignment.json");
      FileUtils.writeStringToFile(resourceAssignmetFile, workingServiceTemplateConmtent, Charset.defaultCharset());
